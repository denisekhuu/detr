...
class HydraMultiheadAttention(MultiheadAttention):
    ...
    def forward(
        ...
        if not why_not_fast_path:
            ...
            if not why_not_fast_path:
                ...
                if (
                    self.in_proj_bias is not None and 
                    self.in_proj_weight is not None and 
                    (effective_heads is None or effective_heads == self.num_heads)):
