...
from sliced_local_head_models.training.engine import train_one_epoch, evaluate
...
#python sliced_local_head_main.py --hidden_dim 128 --dim_feedforward 1024 --nheads 4 --batch_size 2 --epochs 1 --lr_drop 1 --output_dir ../temp/temp_output --coco_path C:/workspace/ml/data/coco
